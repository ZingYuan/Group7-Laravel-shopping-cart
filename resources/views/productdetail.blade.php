...
@section('content')
  @foreach($products as $product)
    ...
    <div class="col-md-6">
      ...
      <a href="{{ route('product.detail',['id'=>$product->id]) }}"><img src="{{ asset('image/') }}/{{$product->image}}" alt=""></a>
      <p>{{$product->description}}</p>
      <div style="height: 100px">Quantity <input type="number" id="qty" value="1" min="1" max="10">
      </div>
