...
<body>
    ...
    <div class="container">
        ...
        <form action="{{route('addProduct.store')}}" method="post" enctype="multipart/form-data">{{csrf_field() }}
            ...
            <div class="form-group">
                <label>CPU:</label>
                <input class="form-control" type="text" name="CPU" required placeholder="Enter Product CPU detail"/>
                <span class="Error"></span>
            </div>
            <div class="form-group">
                <label>OS:</label>
                <input class="form-control" type="text" name="OS" required placeholder="Enter Product OS detail"/>
                <span class="Error"></span>
            </div>
            <div class="form-group">
